...
//		 * 반복문 만드는 원리
//		 * 
//		 * 반복 되는것 찿기 ctrl+c, v 해도 바뀌지 않는 것
//		 * 
//		 * 반복 되지 않는 것의 - 패턴 (규칙)을 찾을 수 있다면 반복문으로 만들 수 있음 변수를 활용해서 반복되게 만들기
//		 * 
//		 * 반복 되지 않는 것의 - 시작 조건 찾기 - 종료 조건 찾기
//		 * 
...
//		i2 = i2 + 1;
//		System.out.println(i2); // 8 //i2++같은말
//		System.out.println("-------------");
//		// for로 만들자
