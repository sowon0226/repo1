...
public class TypeCastingExam {
	...
	public static void main(String[] args) {
		...
		a = (int)c; //큰거에서 작은거로 바뀔 때는 손실이 있을 수 있다
					//형변환을 생략할 수 없다
		           // 명시적 , 강제 형변환
		long d = 3000000000L;
		int a2 =(int)d;
		...
		System.out.println(result / (double) count);//count가 double로 생략됨
		...
		// i3의 값 결과가 -94967296 나온 이유는 넘쳐서 그럼
	    ...
	    Scanner scan = new Scanner(System.in);// 입력을 받을 준비
